...
from .pricing import compute_daily_cost, compute_model_usage_cost, compute_summary_cost, format_cost, select_pricing_model
...
def model_usage_to_dict(value: ModelUsage) -> dict[str, Any]:
    return {
        ...
        "costUsd": round(compute_model_usage_cost(value), 4),
    }
