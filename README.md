...
> **Note:** This is a personal fork of [KMnO4-zx/slopmeter-python](https://github.com/KMnO4-zx/slopmeter-python) (MIT). Added on top of the original:
> - `slopmeter day [DATE]` — single-day detail in the terminal (per-model tokens, cost, and an hourly sparkline)
> - A click/date-picker **day detail panel** in the web UI, with a colored **0–23h hourly distribution chart**
> - Aggregate card/section is hidden automatically when only one provider has data
